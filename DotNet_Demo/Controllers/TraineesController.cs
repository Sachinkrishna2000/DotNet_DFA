...
namespace DotNet_Demo.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public TraineesController(ILogger<TraineesController> logger, IToastNotification toastNotification, dotnetContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Create([Bind("Tid,Tname,Tage")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Tid,Tname,Tage")] Trainee trainee)
        {
            if (id != trainee.Tid)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dotnetContext.Trainees'  is null.");
            }
            var trainee = await _context.Trainees.FindAsync(id);
            if (trainee != null)
            {
